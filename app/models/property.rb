class Property < ActiveRecord::Base
  ...
  # Method calculates area sums. This is used to
  ...
  # When generatign evidence list this method
  # checks if property has any accessories
...
#    Rooms_name << room if room.is_a?(String)
  ...
  # renters rents. It is used when application 
  # checks if sum of rente of renters if equal
  # to expected rent for property. If not
  # application will will show warning.  
  def renters_rent
    rent = 0
    for renter in self.renters do
      rent += renter.rent
